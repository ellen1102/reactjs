        ...
        <div className="row">
          {movieData.data.map((movie, index) => (
            <div key={index} className="col-md-4 d-flex align-items-stretch">
              <Card className="bg-transparent text-white text-center movieImage my-2" style={{ width: '100%', height: '100%', border: '4px solid white' }}>
                <div>
                  <img className="card-img-top" src={movie.foto} alt="Card image cap" style={{ maxHeight: '200px', objectFit: 'cover' }} />
                  <Button
                    as="a"
                    variant="danger"
                ...
                <div className='bg-dark p-2' style={{ flex: '1 1 auto' }}>
